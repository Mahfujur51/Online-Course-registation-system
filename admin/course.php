...
if(strlen($_SESSION['alogin'])==0)
{
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql="INSERT INTO tbl_course(coursecode,coursename,courseunit,noofseat)VALUES('$coursecode','$coursename','$courseunit','$noofseat')";
    ...
    { 
        $id=$_GET['id'];
        $delsql="DELETE FROM tbl_course WHERE id='$id'";
                        ...
                        <div class="panel-body">
                            <form name="dept" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="noofseat" name="noofseat" placeholder="Seat limit" required />
                                </div>
                                ...
                                <tbody>
                                    ...
                                    while($row=mysqli_fetch_array($sql))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($row['noofseat']);?></td>
                                            <td><?php echo htmlentities($row['createdate']);?></td>
                                            <td>
                                                <a href="edit-course.php?id=<?php echo $row['id']?>">
                                                    <button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> </a>
                                                    <a href="course.php?id=<?php echo $row['id']?>" onClick="return confirm('Are you sure you want to delete?')">
