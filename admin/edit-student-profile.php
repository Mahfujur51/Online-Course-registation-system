...
if(strlen($_SESSION['alogin'])==0)
{
  ...
  if(isset($_POST['submit']))
  {
    ...
    $ret=mysqli_query($con,"UPDATE tbl_student SET studentname='$studentname',photo='$photo',cgpa='$cgpa'  WHERE id='$id'");
    if($ret)
    {
        ...
        <div class="row" >
          ...
          <div class="col-md-6">
            <div class="panel panel-default">
              ...
              <?php
              $id=intval($_GET['eid']);
              $sql=mysqli_query($con,"SELECT * FROM tbl_student WHERE id='$id'");
              $cnt=1;
                  ...
                  <div class="panel-body">
                    <form name="dept" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="studentreg" name="studentreg" value="<?php echo htmlentities($row['studentreg']);?>"  placeholder="Student Reg no" readonly />
