...
if(strlen($_SESSION['alogin'])==0)
{
  ...
  if(isset($_POST['submit']))
  {
    ...
    $sql="INSERT INTO tbl_student(studentname,studentreg,password,pincode)VALUES('$studentname','$studentreg','$password','$pincode')";
              ...
              <div class="panel-body">
                <form name="dept" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="studentreg" name="studentreg" onBlur="userAvailability()" placeholder="Student Reg no" required />
    ...
    <script>
      function userAvailability() {
        ...
        jQuery.ajax({
          ...
          data:'studentreg='+$("#studentreg").val(),
          type: "POST",
