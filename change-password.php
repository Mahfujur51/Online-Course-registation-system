...
if(isset($_POST['submit']))
{
  ...
  $sql="SELECT * FROM  tbl_student WHERE password='$password' AND studentreg='$studentreg'";
  $query=mysqli_query($con,$sql);
  $num=mysqli_num_rows($query);
  if ($num>0) {
    $upsql="UPDATE tbl_student SET password='$newpass' WHERE studentreg='$studentreg'";
    $upquery=mysqli_query($con,$upsql);
    if ($upquery) {
      $_SESSION['msg']="Password Changed Successfully !!";
    }else{
      $_SESSION['msg']="Password  Not Changed Successfully !!";
    }
  }else{
    $_SESSION['msg']="Incorret Current Password !!";
  }
}
?>
<!DOCTYPE html>
